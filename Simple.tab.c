...
#line 165 "Simple.tab.c" /* yacc.c:339  */
...
#line 233 "Simple.tab.c" /* yacc.c:355  */
};
...
#line 248 "Simple.tab.c" /* yacc.c:358  */
...
{
     -14,   -53,     6,    11,   -53,   -53,   -53,   -53,   -53,     3,
      24,    26,   -16,    21,   -13,    59,   -53,   -53,   -53,   -53,
      18,    -3,   -53,   -53,   -53,    36,    -3,    19,    -3,   -53,
     -53,   -53,    -3,    98,    -3,   -53,    98,   -53,    98,    86,
      -3,    -3,    -3,    -3,    -3,    -3,    -3,    -3,    43,    98,
     -53,    98,    98,    98,     9,     9,    33,    33,    33,    39,
      42,    89,    26,    60,    72,   -53,   -53,    52,    76,   -53
};
...
{
      29,    30,    31,    36,     1,    38,     4,    61,    12,    39,
      64,    49,     5,    16,    17,    68,    19,    51,    52,    53,
      54,    55,    56,    57,    58,     6,     7,    14,    32,    13,
       8,   -10,   -10,   -10,   -10,    45,    46,    47,    28,   -10,
      14,    35,   -10,   -10,   -10,   -10,   -10,   -10,    37,   -10,
      18,    17,    59,    14,    62,   -10,   -10,   -10,   -10,   -10,
     -10,    47,    10,   -10,    20,    21,    22,    23,   -10,   -10,
      65,     0,    24,     0,     0,    25,    26,    20,    21,    22,
      23,    20,    21,    22,    23,    66,     0,    69,    25,    26,
       0,     0,    25,    26,    20,    21,    22,    23,     0,     0,
       0,     0,     0,     0,     0,    25,    26,    40,    41,    42,
      43,    44,    45,    46,    47,     0,     0,     0,    50,    40,
      41,    42,    43,    44,    45,    46,    47
};

static const yytype_int8 yycheck[] =
{
       3,     4,     5,    26,    18,    28,     0,    59,     5,    32,
      62,    34,     1,    29,    30,    67,    29,    40,    41,    42,
      43,    44,    45,    46,    47,    14,    15,     1,    31,     5,
      19,     5,     6,     7,     8,    26,    27,    28,    20,    13,
       1,     5,    16,    17,     5,     6,     7,     8,    29,    10,
      29,    30,     9,     1,    12,    16,    17,     5,     6,     7,
       8,    28,     7,    11,     5,     6,     7,     8,    16,    17,
      10,    -1,    13,    -1,    -1,    16,    17,     5,     6,     7,
       8,     5,     6,     7,     8,    13,    -1,    11,    16,    17,
      -1,    -1,    16,    17,     5,     6,     7,     8,    -1,    -1,
      -1,    -1,    -1,    -1,    -1,    16,    17,    21,    22,    23,
...
#line 130 "Simple.y" /* yacc.c:1646  */
    { add_name_to_buf((yyvsp[-1].id)); flush_to_table(INT_T); }
#line 1387 "Simple.tab.c" /* yacc.c:1646  */
    break;

  case 6:
#line 131 "Simple.y" /* yacc.c:1646  */
    { add_name_to_buf((yyvsp[-1].id)); flush_to_table(FLOAT_T); }
#line 1393 "Simple.tab.c" /* yacc.c:1646  */
    break;

  case 9:
#line 135 "Simple.y" /* yacc.c:1646  */
    { add_name_to_buf((yyvsp[-1].id));											}
#line 1399 "Simple.tab.c" /* yacc.c:1646  */
    break;

  case 14:
#line 142 "Simple.y" /* yacc.c:1646  */
    { enum types t = get_type((yyvsp[0].id));  if(t == INT_T) {context_check(READ_INT, (yyvsp[0].id)); 	} 
	                                                                               else  if(t == FLOAT_T) { context_check(READ_FLOAT, (yyvsp[0].id));  } 		}
...
#line 145 "Simple.y" /* yacc.c:1646  */
    { enum types t = get_type((yyvsp[-2].id));  if(t == INT_T) {context_check(STORE_INT, (yyvsp[-2].id)); 	} 
	                                                                               else  if(t == FLOAT_T) { context_check(STORE_FLOAT, (yyvsp[-2].id));   }	}
...
#line 165 "Simple.y" /* yacc.c:1646  */
    { gen_code(LT, 0);											}
#line 1488 "Simple.tab.c" /* yacc.c:1646  */
    break;

  case 28:
#line 166 "Simple.y" /* yacc.c:1646  */
    { gen_code(EQ, 0);											}
#line 1494 "Simple.tab.c" /* yacc.c:1646  */
    break;

  case 29:
#line 167 "Simple.y" /* yacc.c:1646  */
    { gen_code(GT, 0);											}
#line 1500 "Simple.tab.c" /* yacc.c:1646  */
    break;
